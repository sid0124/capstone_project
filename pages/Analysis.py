...
# Load dataset
new_df = pd.read_csv('C:/Users/Sidharth Arora/My_project/PythonProject/dataset/data_viz1.csv')
feature_text = pickle.load(open('C:/Users/Sidharth Arora/My_project/PythonProject/dataset/feature_text.pkl','rb'))
